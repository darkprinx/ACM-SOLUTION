...
/*
   ...
   Problem Name: 1124 - CRICKET RANKING
       Platform: LightOj
      Algorithm: Inclusion/Exclusion/Combinatorics
...
int dp(int x,int r)
{
    int xx= (f[r]*(ll)f[x-r])%mod;
    xx= (f[x]*(ll)mod_inv(xx,mod))%mod;
    return xx;
}
