/*
   ...
   Problem Name: 1276 - VERY LUCKY NUMBERS
       Platform: LightOj
     Algorithom: Binary search/ backtracking
...
int main()
{
    ...
    Sfor(test)
    {
        ...
        int pos=lower_bound(all(num),a)-num.begin();
        int bos=upper_bound(all(num),b)-num.begin();
        pf("Case %d: %d\n",i,bos-pos);
    }
    return 0;
}
