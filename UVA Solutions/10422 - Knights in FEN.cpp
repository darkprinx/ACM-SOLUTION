...
st chng(st a,int pos)
{
    ...
    if(a.maze[i][j]==' ')
    {
        ...
        if(BOUNDARY(nx,ny,5,5))
            swap(a.maze[i][j],a.maze[nx][ny]);
        return a;
    }
}
