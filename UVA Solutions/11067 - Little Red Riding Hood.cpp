/*
   ...
   Problem Name: 11067 - Little Red Riding Hood
       Platform: Uva
     Algorithom: DP
...
int main()
{
    ...
    while(fs(n)&&fs(m)&&n&&m)
    {
        ...
        if(!dp[n][m])
            ...
            pf("There is one path from Little Red Riding Hood's house to her grandmother's house.\n");
        else
            pf("There are %lld paths from Little Red Riding Hood's house to her grandmother's house.\n",dp[n][m]);
    }
    return 0;
}
